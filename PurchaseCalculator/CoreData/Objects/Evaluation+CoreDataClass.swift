...
public class Evaluation: NSManagedObject {
    ...
    class func createWith(itemName: String, unitName: String, unitCost: Double, score: Double, attributeEvaluations: [AttributeEvaluation], penaltyApplied: Bool, in context: NSManagedObjectContext = CoreDataManager.shared.moc) -> Evaluation {
