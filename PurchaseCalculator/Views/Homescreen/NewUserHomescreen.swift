...
struct NoUserHomescreen: View {
    ...
    var body: some View {
            VStack {
                Spacer()
                CTAButton(text: "add_profile_cta", imageWrapper: ImageWrapper(name: "profile_block_cta_image"), animationPeriod: 1, animationOccurenceHandler: animationHandler, width: 110, height: 110) {
